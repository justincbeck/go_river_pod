...
abstract class $AuthModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? username, AuthState authState});
}
...
class _$_AuthModel implements _AuthModel {
  _$_AuthModel({this.username, required this.authState});
  ...
  @override
  String toString() {
    return 'AuthModel(username: $username, authState: $authState)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, username, authState);
...
abstract class _AuthModel implements AuthModel {
  factory _AuthModel(
      {final String? username,
      required final AuthState authState}) = _$_AuthModel;
